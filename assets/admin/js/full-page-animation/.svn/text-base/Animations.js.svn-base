...
var XHRCSSFiles = function() {
	...
	request.open("GET", "/assets/admin/js/full-page-animation/css/FullPageAnimationsPrefixed.css", false);
	request.send("");
	...
	request2.open("GET", "/assets/admin/js/full-page-animation/css/DemoTransformsAnimations.css", false);
	request2.send("");
...
SetPerspectiveForHTMLTag("500px");

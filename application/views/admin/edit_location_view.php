                        ...
                        <div class="form-body form-horizontal">
                            <form role="form" id="addLocationForm" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="locationSubTitle" placeholder="Enter Location Title" value="<?php echo $location->ts_location_subtitle;?>" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="locationDescription" rows="12" placeholder="Location Description" class="form-control"><?php echo $location->ts_location_description; ?></textarea>
                                    </div>
                                </div>

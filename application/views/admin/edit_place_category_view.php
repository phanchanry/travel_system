                ...
                <div class="portlet-body form">
                    <div class="form-body form-horizontal">
                        <form role="form" id="addPlaceCategoryForm" method="post">
                            <input type="hidden" name="categoryId" value="<?php echo $categoryList->category_id;?>" />
                            <div class="form-group">
                                <label class="col-md-3 control-label">Category Title<span class="required">*</span></label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="categoryTitle" value="<?php echo $categoryList->ts_category_title;?>"/>
                                </div>
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-2" id="category_image_view" >
                                <img src="<?php echo $categoryList->ts_category_image;?>" />
                            </div>
                         </div>
                         <div class="form-group">
                            ...
                            <div class="col-md-2" id="marker_image_view">
                                 <img src="<?php echo $categoryList->ts_category_marker;?>" />
                            </div>
                         </div>
                     </div>
